        ...
        <FooterStyled className="text-center pt-4 pb-5 py-lg-3">
            <Container className="d-lg-flex align-items-center">
                ...
                <Nav className="justify-content-center">
                    ...
                    <Nav.Link href="https://web.whatsapp.com/send/?phone=5521996443691&text=Ol%C3%A1,%20gostaria%20de%20fazer%20um%20pedido!" target='_blank' rel='noreferrer noopener' className="py-0 px-2">
